...
// requests and the DB row sane on a free-tier database.
const MAX_IMAGE_LENGTH = 4_000_000;

/**
 * Validates and normalises a notice payload coming from the client.
 * This is intentionally strict and only ever returns the exact set of
 * fields we accept, so arbitrary extra/unexpected fields in the request
